...
export async function getTripImage(destination) {
  try {
    ...
    return `https://places.googleapis.com/v1/${pname}/media?maxHeightPx=400&maxWidthPx=400&key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}`;
