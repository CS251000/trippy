...
export default function GoogleMapsAutocomplete({ onLocationSelect, value }) {
    ...
    useEffect(() => {
        const inputElement = document.getElementById("place-autocomplete-input");
    ...
    return (
        <div>
            <input
                ...
                className="rounded p-2 border text-sm w-full mb-2 bg-gray-50"
            />
            <div ref={mapRef} style={{ height: "30vh", width: "100%" }} className="mb-2"></div>
        </div>
    );
}
